...
const title = "KI-Video erstellen aus Text – online mit KI";
const description =
...
const faqs: SeoFaq[] = [
  {
    question: "Welche Videolängen kann ich erstellen?",
    answer: "Du kannst aktuell zwischen 8 Sekunden, 30 Sekunden, einer Minute und zwei Minuten wählen. Längere Formate werden erst nach abgeschlossenen Qualitätstests freigeschaltet.",
  },
  {
    question: "Welche Videoformate werden unterstützt?",
    answer: "Für Reels, TikTok und Shorts steht das vertikale Format 9:16 bereit. Für YouTube, Webseiten und filmische Projekte kannst du 16:9 verwenden.",
  },
  {
    question: "Kann ich das Ergebnis vor der Bezahlung prüfen?",
    answer: "Der KI-Regisseur entwickelt zunächst Story und Szenenplan. Zusätzlich kannst du eine visuelle Vorschau erzeugen, bevor du das vollständige Video bestellst.",
  },
];
...
export const metadata = productMetadata({
  ...
  keywords: ["KI Video erstellen", "Text zu Video KI", "KI Videogenerator", "KI Reel erstellen", "AI Video erstellen"],
});

const jsonLd = productJsonLd({
  name: "KI-Videogenerator",
  description,
  path: STUDIO_PATHS.video,
  ...
  return (
    <>
      ...
      <SeoContent
        ...
        benefits={[
          "Wähle zwischen 8 Sekunden, 30 Sekunden, einer Minute und zwei Minuten.",
