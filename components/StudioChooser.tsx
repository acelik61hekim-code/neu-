...
import { FilmIcon, MusicIcon } from "@/components/Icons";

export type StudioMode = "video" | "song";
...
export default function StudioChooser({
  ...
  return (
    <div
      className={`grid grid-cols-2 gap-2 rounded-2xl border border-white/10 bg-black/25 p-2 shadow-xl shadow-black/20 ${compact ? "w-full max-w-sm" : "mx-auto mt-7 w-full max-w-xl"}`}
