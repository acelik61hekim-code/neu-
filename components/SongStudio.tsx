    ...
    <main className="relative min-h-screen overflow-hidden bg-[#07070b] text-white">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-5 pb-20 pt-12 sm:px-8 sm:pt-16">
        <section className="mx-auto max-w-3xl text-center">
          ...
          <a href="/sound-studio" className="mt-4 inline-flex items-center gap-2 rounded-xl border border-fuchsia-400/20 bg-fuchsia-400/[0.07] px-4 py-2.5 text-xs font-semibold text-fuchsia-200 transition hover:bg-fuchsia-400/[0.12]">
            <SparklesIcon /> Sound Studio vor dem Abo ansehen
          </a>
        </section>
