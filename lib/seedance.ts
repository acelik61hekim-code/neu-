  ...
  return submitSeedance(
    ...
    ),
    {
      prompt: [
        ...
        "SEAMLESS FIRST-FRAME MATCH (highest priority): Begin with a pixel-aligned continuation of @Video1's final frame. Preserve the exact camera position, focal length, field of view, crop, horizon, subject size and subject placement for at least the first half-second.",
        "Do not zoom, resize, reframe, refocus, jump, cut or reset camera motion at the beginning of this continuation.",
        "SEAMLESS AUDIO BRIDGE (highest priority): Continue the active ambience, music, rhythm and room tone from @Video1 without silence, fade-in, beat reset, volume jump or a newly started musical phrase at the boundary.",
